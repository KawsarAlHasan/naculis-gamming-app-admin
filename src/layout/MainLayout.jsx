...
const MainLayout = () => {
  ...
  return (
    <Layout>
      {/* Header */}
      <Header className="bg-[#2E3F49] sticky top-0 z-10 w-full flex items-center p-0 h-16">
      ...
      <Layout>
        ...
        <Layout style={{ marginLeft: isLargeScreen ? 320 : 0 }}>
          <Content>
            <div
              className="p-4 lg:px-12 text-white min-h-[93vh]"
              style={{ background: "#4f6572" }}
            >
              <div className="flex items-center gap-x-2 mb-5">
                <ArrowLeftOutlined
                  onClick={handleGoBack}
                  className="text-white text-[30px] mt-1 font-semibold cursor-pointer hover:text-gray-300"
                />
